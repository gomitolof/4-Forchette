    ...
    foreach ($arr as $key => $value) {
      switch ($key) {
        ...
        case 'nome':
          ...
          $result[$key] = (lunghezzacompresa($value, 45, 2) && (tipostringa($value) == '100' || tipostringa($value) == '110'))? 1 : 0;
          break;
